  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mt-3 min-w-0">
        <p className="truncate text-2xl font-extrabold tracking-tight text-foreground">{value}</p>
        <p className="mt-1 truncate text-[11px] font-medium text-muted-foreground">{period}</p>
      </div>
